sap.ui.define([
    ...
    return BaseController.extend("templatelistanddetail.templatelistanddetail.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("CaseOrder", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "templatelistanddetail.templatelistanddetail.view.ViewSettingsDialog",
                    controller: this
        ...
        _showDetail: function (oItem) {
            ...
            this.getRouter().navTo("object", {
                objectId : oItem.getBindingContext().getProperty("CaseOrder")
            }, bReplace);
        },
