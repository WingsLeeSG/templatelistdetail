		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#templatelistanddetailtemplatelistanddetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"templatelistanddetailtemplatelistanddetail-display": {
								"semanticObject": "templatelistanddetailtemplatelistanddetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=templatelistanddetail.templatelistanddetail",
									"url": sap.ui.require.toUrl("templatelistanddetail/templatelistanddetail")
								}
							}
						}
					}
